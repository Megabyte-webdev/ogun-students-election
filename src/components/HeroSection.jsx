...
import { Activity, ChevronRight, Users, Vote, Info } from "lucide-react";
...
export default function HeroSection({
  ...
  const voteSummary = useLiveVotes();

  // 1. Calculate Total Votes across all positions
  ...
  return (
    <section className="relative pt-12 md:pt-20 pb-24 px-6 overflow-hidden min-h-[90vh] flex items-center">
      ...
      <div className="max-w-7xl mx-auto relative z-10 grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          {loading ? (
            ...
            <div className="text-left p-10 border border-dashed border-white/10 rounded-[2.5rem] bg-slate-900/30 backdrop-blur-md">
              ...
              <p className="text-slate-400 max-w-md leading-relaxed">
                ...
                official schedule for upcoming election cycles.
              </p>
            </div>
          ) : (
            <>
              ...
              <div className="lg:hidden flex items-center gap-6 mb-10 p-4 rounded-2xl bg-white/5 border border-white/10 w-fit">
                <div>
        ...
        {/* RIGHT COLUMN: SCALABLE SCOREBOARD */}
        <div className="lg:col-span-5 relative">
          <motion.div
            initial={{ opacity: 0, scale: 0.95 }}
            animate={{ opacity: 1, scale: 1 }}
            className="bg-slate-900/40 backdrop-blur-xl p-8 rounded-[2.5rem] border border-white/10 shadow-2xl relative flex flex-col h-145"
          >
            {/* Sidebar Header */}
            ...
            {/* Scalable Scroll Area for many positions */}
